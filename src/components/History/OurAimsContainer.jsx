                        ...
                        <Card className='ourAimCard'>
                            <Card.Body className='ourAimBody'>
                                <Card.Text className='ourAimText'>
                                    <p>
                                        The main aim of ESOL PERTH is to improve the quality of life for people from other countries by teaching them how to <b>speak, read and write in English.</b>
                                    </p>
                                </Card.Text>
                            </Card.Body>
                        </Card>
